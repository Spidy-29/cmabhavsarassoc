         ...
         <div className="container mx-auto px-4">
           <div className="text-center mb-12">
             ...
             <p className="text-muted-foreground max-w-2xl mx-auto">
               The firm has experience to provide best services from small to large companies in following industrial sectors
             </p>
           </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
             ...
             <Card className="h-full">
               ...
               <CardContent>
                 ...
                 <ul className="space-y-2 text-sm text-muted-foreground">
                   ...
                   <li>• Connecting  Rod, Crank Shaft, Motor Vehicle Parts etc.</li>
             ...
             <Card className="h-full">
               ...
               <CardContent>
                 <p className="text-muted-foreground mb-4">
                   The firm has experience to provide best services from small to large companies in following service sectors:
                 </p>
                 <ul className="space-y-2 text-sm text-muted-foreground">
                   <li>• Electricity (Generation, Distribution, Customer Service)</li>
                   <li>• Telecommunications</li>
                   <li>• Ports and ports related activities</li>
                   <li>• Roads & other Infrastructures Project and Road Related Services</li>
                   <li>• Logistics</li>
                   <li>• Health Care</li>
                   <li>• Diagnostic Centres, Clinical Centres and Test Laboratories</li>
                 </ul>
